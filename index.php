...
<body class="bg-dark text-cream font-sans antialiased">
    ...
    <div id="hero-section"
        class="fixed inset-0 w-full h-screen z-0 flex items-center justify-center bg-dark transition-opacity duration-75">
                    ...
                    <div class="glass-panel rounded-xl p-6 space-y-8 sticky top-24">
                        <div class="flex items-center justify-between">
                            ...
                            <button onclick="clearFilters()"
                                class="text-xs text-secondary hover:text-primary transition uppercase tracking-wider">Réinitialiser</button>
                        </div>

                        <!-- Category Filter -->
                        <div>
                            <label
                                class="block text-xs font-bold text-secondary uppercase tracking-wider mb-4">Catégorie</label>
                        ...
                        <div>
                            <label
                                class="block text-xs font-bold text-secondary uppercase tracking-wider mb-4">Type</label>
                            <div class="space-y-3">
                                <label class="flex items-center cursor-pointer group">
                                    <input type="radio" name="type" value="" checked onchange="updateFilters()"
                                        class="mr-3 text-primary focus:ring-primary bg-transparent border-surface">
                                    <span class="text-sm text-light group-hover:text-primary transition">Tous</span>
                                </label>
                                <label class="flex items-center cursor-pointer group">
                                    <input type="radio" name="type" value="sale" onchange="updateFilters()"
                                        class="mr-3 text-primary focus:ring-primary bg-transparent border-surface">
                                    <span class="text-sm text-light group-hover:text-primary transition">Vente</span>
                                </label>
                                <label class="flex items-center cursor-pointer group">
                                    <input type="radio" name="type" value="rent" onchange="updateFilters()"
                                        class="mr-3 text-primary focus:ring-primary bg-transparent border-surface">
                        ...
                        <div>
                            <label
                                class="block text-xs font-bold text-secondary uppercase tracking-wider mb-4">Taille</label>
                        ...
                        <div>
                            <label
                                class="block text-xs font-bold text-secondary uppercase tracking-wider mb-4">Couleur</label>
                ...
                <main class="flex-1">
                    ...
                    <section id="sale-section" class="mb-16">
                        <div class="flex items-end justify-between mb-8 border-b border-surface pb-4">
                            <h2 class="text-4xl font-serif font-bold text-primary">En Vente</h2>
                    ...
                    <section id="rent-section">
                        <div class="flex items-end justify-between mb-8 border-b border-surface pb-4">
                            <h2 class="text-4xl font-serif font-bold text-primary">En Location</h2>
    ...
    <div id="costume-modal" class="fixed inset-0 z-50 hidden" aria-labelledby="modal-title" role="dialog"
        aria-modal="true">
        <!-- Backdrop -->
        <div id="modal-backdrop"
            class="fixed inset-0 bg-black/80 backdrop-blur-sm transition-opacity opacity-0 duration-300 ease-out"
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto">
            <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                <!-- Modal Panel -->
                <div id="modal-panel"
                    class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-2xl transition-all opacity-0 translate-y-4 scale-95 duration-300 ease-out sm:my-8 sm:w-full sm:max-w-4xl">
                    <div class="absolute right-4 top-4 z-10">
                        <button type="button"
                            class="rounded-full bg-white/80 p-2 text-gray-400 hover:text-gray-500 hover:bg-white transition focus:outline-none"
                            onclick="closeModal()">
                        ...
                        <div class="w-full md:w-1/2 p-8 md:p-12 bg-cream">
                            <div class="mb-6">
                                <span id="modal-category"
                                    class="text-sage font-bold tracking-widest uppercase text-xs"></span>
                            ...
                            <div class="space-y-6">
                                <div>
                                    <h3 class="text-sm font-bold text-charcoal uppercase tracking-wide mb-2">Description
                                    </h3>
                                    <p id="modal-description" class="text-charcoal/70 leading-relaxed"></p>
                                </div>

                                <div>
                                    <h3 class="text-sm font-bold text-charcoal uppercase tracking-wide mb-3">Tailles
                                        Disponibles</h3>
                                ...
                                <div class="pt-6 mt-6 border-t border-sage/20">
                                    <button onclick="addToCartFromModal()"
                                        class="w-full bg-charcoal text-white font-bold py-4 rounded-xl hover:bg-sage transition-colors duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-3 group">
